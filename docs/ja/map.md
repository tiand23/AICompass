...
| Topic | 何か | 解決する問題 | 状態 | 最終更新 |
|---|---|---|---|---|
| [model-efficiency](/ja/topics/model-efficiency) | SLM、蒸留、量子化、効率アーキテクチャ、CPU/エッジ推論 | より少ない計算資源で十分な知能を | 🔥 | 2026-08-10 |
...
| [agent-skills](/ja/topics/agent-skills) | 再利用可能な能力パッケージ（GitHub 熱度ランキング付き） | エージェント能力の配布と再利用 | 🔥 | 2026-08-09 |
...
| Topic | 何か | 解決する問題 | 状態 | 最終更新 |
|---|---|---|---|---|
| [agentic-safety](/ja/topics/agentic-safety) | エージェントの行動安全性 | 自律モデルの越権・脱出という現実リスク | 🔥 | 2026-08-10 |
